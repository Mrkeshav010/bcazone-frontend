      ...
      <div className="max-w-3xl mx-auto py-10 px-4">
        {!showCert ? (
          <div className="card text-center">
            ...
            <input className="input w-full max-w-md mx-auto block mb-4 text-center text-lg font-semibold"
          ...
          <div>
            ...
            <div ref={certRef}>
              <div style={{
                ...
                <h2 style={{ fontSize: '28px', fontWeight: 900, color: '#4f46e5', marginBottom: '8px' }}>{courseTitle}</h2>
                <p style={{ fontSize: '14px', color: '#9ca3af', marginBottom: '32px' }}>Score: {score}/100 • Date: {today}</p>
