...
const COURSE_PAGES = {
  'python': 80, 'java': 85, 'c-programming': 70, 'cpp': 75,
  'web-development': 110, 'data-structures': 90, 'data-science': 95,
  'dsa': 85, 'cybersecurity': 80, 'android': 85, 'cloud': 75, 'devops': 75,
};
...
const CourseReader = () => {
  ...
  // Exam sirf tab dikhega jab SABHI pages complete ho jayein
      ...
      <div className="max-w-4xl mx-auto py-6 px-4">
        ...
        <div className="bg-white rounded-2xl shadow p-4 mb-6">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <button onClick={() => navigate('/courses')} className="text-indigo-600 text-sm font-semibold mb-1 block">
                ← Back to Courses
              </button>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          {/* Last page pe — agar complete nahi to Mark Complete, agar complete to Get Certificate */}
        ...
        {/* Completion Banner — sirf tab jab sab complete ho */}
        {allCompleted && (
