...
const Messages = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto px-2 md:px-4 py-4 flex gap-3 overflow-hidden" style={{ height: 'calc(100vh - 64px)' }}>
            ...
            <>
              ...
              <div className="p-3 md:p-4 border-b border-gray-100 flex items-center gap-3 bg-white flex-shrink-0">
                ...
                <button onClick={() => setShowChat(false)}
                  className="md:hidden p-1 text-indigo-600 font-bold text-lg">
                  ←
                </button>
                <img
                  ...
                  className="w-9 h-9 rounded-full object-cover border-2 border-indigo-200 flex-shrink-0"
                ...
                {messages.map((m, i) => {
                  ...
                  return (
                    <div key={i} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                      <div className={`max-w-[75%] px-3 py-2 rounded-2xl text-sm shadow-sm ${isMe ? 'bg-indigo-600 text-white' : 'bg-white text-gray-800'}`}>
                        <p>{m.text}</p>
